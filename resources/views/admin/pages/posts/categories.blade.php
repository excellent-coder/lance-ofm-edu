                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <button class="btn btn-danger bulk-action" title="Delete all selected categories"
                                ...
                                data-action="{{route('admin.post-cats.destroy')}}" data-id="">
        ...
        <div class="card">
            <x-admin-card-tool title="Post Categories">
                <button class="text-white btn btn-success btn-tool dropdown-toggle btn-sm" data-target="#general-modal"
                    ...
                    data-store_route="{{route('admin.post-cats.store')}}">
                    new Post Category
                </button>
            </x-admin-card-tool>
            <div class="card-body ">
                    ...
                    <div class="col-12">
                        <table id="dataTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                $action = [
                                'modal'=>'general',
                                'destroy'=> route('admin.post-cats.destroy'),
                                ...
                                <?php
                                $action['id'] = $c->id;
                                $action['update_route']= route("admin.post-cats.update", $c->id);
        ...
        <form action="{{route('admin.user-categories.store')}}" autocomplete="off" @submit.prevent="submit($event)"
            ...
            <div class="form-group">
                <div class="checkbox checkbox-primary p-t-0">
                    <input id="editing-active" data-checked="true" type="checkbox"  name="active" value="1">
