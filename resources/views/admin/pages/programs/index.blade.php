    ...
    <div class="col-md-12">
        <div class="card">
            <x-admin-card-tool title="Courses">
                <a href="{{route('admin.programs.create')}}" class="btn btn-success btn-sm">
                    New Program
                </a>
            </x-admin-card-tool>
            <div class="card-body ">
                    ...
                    <div class="col-12">
                        <table id="dataTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                @php
                                $action = [
                                    'destroy'=> route('admin.programs.destroy'),
                                ...
                                <?php
                                $action['id'] = $c->id;
                                $action['update_route']= route("admin.programs.update", $c->id);
                                $action['rowid'] = "#tr-$c->id";
                                $action['route'] = route('admin.programs.edit', $c->id);
