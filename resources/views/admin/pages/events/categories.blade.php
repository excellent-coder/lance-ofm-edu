                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <button class="btn btn-danger bulk-action" title="Delete all selected categories"
                                ...
                                data-action="{{route('admin.event-cats.destroy')}}" data-id="">
                    ...
                    <div class="col-12">
                        <table id="dataTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                $action = [
                                'modal'=>'general',
                                'destroy'=> route('admin.event-cats.destroy'),
                                ...
                                <?php
                                $action['id'] = $c->id;
                                $action['update_route']= route("admin.event-cats.update", $c->id);
...
<div>
    <x-admin-modal title="Event Category">
        <form action="{{route('admin.event-cats.store')}}" autocomplete="off" @submit.prevent="submit($event)"
