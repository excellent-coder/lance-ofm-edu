    ...
    <div class="col-12">
        <div class="card">
            <x-admin-card-tool title="New Publication">
                <a href="{{route('admin.pubs.create')}}" target="_blank" class="text-white btn btn-success btn-sm">
                    New Publication
                </a>
            </x-admin-card-tool>
            <div class="card-body ">
                <div class="row">
                    <div class="my-3 col-12" style="background-color: indigo;">
                        <div class="row justify-content-end">
                            <a href="{{route('admin.pubs.create')}}" target="_blank" class="btn btn-success">
                                New Publication
                            </a>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="card-body">
                            <form method="POST" @submit.prevent="submit($event)"
                                action="{{route('admin.pubs.update', $publication->id)}}">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-7 col-12">
                                        <div class="mb-4 form-group">
                                            ...
                                            <input class="form-control required" type="text" name="title"
                                                placeholder="title" value="{{$publication->title}}" autocomplete="off">
                                        </div>
                                        <div class="form-group">
                                            <label>Description</label>
                                            <textarea class="form-control required tinymce" name="description" rows="12">{!! $publication->description !!}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-5">
                                        <div class="form-group">
                                            ...
                                            <select data-placeholder="category" id="category" class="form-control select2 required" name="category">
                                                ...
                                                <option value="{{$t->id}}"  {{$publication->cat_id == $t->id?'selected':''}}>{{$t->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="mb-4 form-group">
                                            ...
                                            <input class="form-control" type="text" name="volume"
                                                placeholder="volume" value="{{$publication->volume}}" autocomplete="off">
                                        </div>
                                        <div class="mb-4 form-group">
                                            <label for="price">price</label>
                                            <input class="form-control" type="text" inputmode="numeric" name="price"
                                                placeholder="price" autocomplete="off" value="{{$publication->price}}">
                                        </div>
                                        <div class="form-group">
                                          <label for="docs">choose file to update Document</label>
                                          <input type="file" class="form-control-file simple-file" accept=".pdf,.docx" name="docs" id="docs" placeholder="document"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row selected-files"
                                                v-if="files.image && files.image.length || '{{$publication->image}}' && !form.remove_image">
                                                <div
                                                    class="px-3 col-12 select-cover-photo selected preview-file featured-photo">
                                                    <img :src="(files.image && files.image[0])?fileSrc(files.image[0].file):'/storage/{{$publication->image}}'"
                                                ...
                                                <div class="form-group col-6 col-lg-3">
                                                    <div class="checkbox checkbox-primary p-t-0">
                                                        <input id="featured" type="checkbox"
                                                            class="form-check-input form-control" {{$publication->featured?'checked':''}} name="featured"
                                                            value="1">
                                                        <label for="featured">
                                                            Featured
                                                        </label>
                                                ...
                                                <div class="form-group col-6 col-lg-3">
                                                    <div class="checkbox checkbox-primary p-t-0">
                                                        <input id="published" type="checkbox"
                                                            class="form-check-input form-control" {{$publication->published?'checked':''}} name="published"
                                                            value="1">
                                                        <label for="published">
                                                            Published
                                                        </label>
