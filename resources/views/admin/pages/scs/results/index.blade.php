...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            <x-admin-card-tool title="Short Course Student results for {{$year}}">
                <div class=" dropdown-divider"></div>
                <a href="{{route('admin.scs.results.create')}}" class=" btn btn-success btn-sm">
                    Add Result
                </a>
            </x-admin-card-tool>
            <div class="card-body ">
                <div class="row">
                    <div class="my-3 col-12" style="background-color: indigo;">
                        <div class="row justify-content-end">
                            <a href="{{route('admin.scs.results.create')}}" class="btn btn-success">
                                Add Result
                            </a>
                        </div>
                    </div>
