    ...
    <div class="container">
        <div class="grid-cols-1 px-3 md:gap-3 md:grid md:grid-cols-3">
            <div class="w-full">
                ...
                <ul class="flex justify-start w-full pb-2 space-x-2">
                    <li>
                        <a href="#" class="p-2 text-black transition-all bg-white hover:bg-yellow-500 hover:text-white">
            ...
            <div class="w-full">
                ...
                <ul class="space-y-2 list-item">
                    ...
                    <li>50 Olowu Street, Ikeja, Lagos State, Nigeria</li>
                    <li>+2348065674312, 08065674312</li>
                </ul>
            </div>
...
<div class="p-5 text-center text-green-100" style="background-color: #1f1f1f;">
    <p class="text-base ">
        ...
        and Management
        <span class="block">
            Design By : Ofemco International Services Ltd
        </span>
    </p>
</div>
<button  id="scroll-to-top" class="fixed bottom-0 right-0 px-3 py-2 text-green-100 bg-gray-800 hover:bg-yellow-500 hover:text-white"><i class="fa fa-angle-up"></i></button>
