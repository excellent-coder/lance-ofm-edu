  <carousel-slide id="1">
            <div class="bg-black slider-item" role="option">
                <div class="flex flex-col justify-center px-5 text-center slider-caption md:px-10 lg:px-20">
                    ...
                    <div class="flex flex-wrap justify-center w-full mt-4 lg:justify-end">
                        <a href="contact" class="p-2 mr-3 text-xl font-semibold text-gray-900 transition-all bg-yellow-500 border-2 border-white hover:text-yellow-500 hover:bg-white">
                            CONTACT US
                        </a>
                        <a href="contact" class="p-2 text-xl font-semibold text-gray-900 transition-all bg-yellow-500 border-2 border-white hover:text-yellow-500 hover:bg-white">
                            READ MORE
                        </a>
                    </div>
                </div>
            ...
            <div class="bg-black slider-item" role="option">
                <div class="flex flex-col justify-center px-5 text-center slider-caption md:px-10 lg:px-20">
                    ...
                    <p class="text-base font-semibold text-right text-white lg:text-2xl md:text-xl">
                        The Institute’s qualifications are accredited
                        and graded for employment in all
            ...
            <div class="bg-black slider-item" role="option">
                <div class="flex flex-col justify-center px-5 text-center slider-caption md:px-10 lg:px-20">
                    <h1 class="w-full mb-3 text-2xl font-semibold text-center text-white lg:text-6xl md:text-3xl">
                        <span class="text-yellow-500 ">
                            Institute Of School
                        </span>
                        <span>
                    ...
                    <p class="text-base font-semibold text-center text-white lg:text-2xl md:text-xl">
                        The Institute’s qualifications are accredited
                        and graded for employment in all
                        sectors of the economy.
                    </p>
