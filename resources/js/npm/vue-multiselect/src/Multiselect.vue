        ...
        <div ref="tags" class="multiselect__tags">
            ...
            >
                <slot name="singleLabel" :option="singleValue">
                    <span v-html="currentOptionLabel"></span>
                </slot>
                <!-- {{ currentOptionLabel }} -->
            </span>
            <span
                    ...
                    <li v-if="multiple && max === internalValue.length">
                        <span class="multiselect__option">
                            <slot name="maxElements"
                                >Maximum of {{ max }} options selected. First
                                remove a selected option to select
                                another.</slot
                            >
                        </span>
                    </li>
                    <template v-if="!max || internalValue.length < max">
                        ...
                        >
                            ...
                            <span
                                ...
                                "
                                :data-select="
                                    groupSelect && selectGroupLabelText
                                "
                                :data-deselect="
                                    groupSelect && deselectGroupLabelText
                                "
                                :class="groupHighlight(index, option)"
                                @mouseenter.self="
                                    groupSelect && pointerSet(index)
                                "
