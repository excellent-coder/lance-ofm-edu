...
var app = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createApp)({
  setup: function setup() {
    ...
    var getCountries = function getCountries() {
      axios.get("/api/address/countries").then(function (res) {
    ...
    var getStates = function getStates(countryId) {
      axios.get("/api/address/countries/".concat(countryId)).then(function (res) {
    ...
    var editPage = function editPage() {
      ...
      axios.get('/portal/profile/status').then(function (res) {
  ...
  methods: {
    ...
    processResponse: function processResponse(data) {
      ...
      if (data.errors) {
        ...
        var description = '';
        var title = data.message ? data.message : 'You have some errors';
        errors.forEach(function (item) {
          description += "* ".concat(item);
        }); // ret
